  ...
  <div class="box-body">
    ...
    <table class="table table-bordered table-hover">
      <tr> 
        ...
        <th><?php echo $MODULE->getSortingHeader("localidad", "Localidad");?></th>
        <th><?php echo $MODULE->getSortingHeader("state", "Estado");?></th>
      </tr>
      <?php
      $lCrmPlanta = CrmPlantaChd::getList_Paging();
      ...
      foreach ($lCrmPlanta as $oItem) {
        ...
        <tr> 
          <td><a href="<?php echo "javascript:Edit(".$oItem->plantaID.");"; ?>"><i class="fa fa-edit"></i></a>
            ...
            <td><?php echo $oItem->localidadPlanta; ?></td>
            <td><?php echo CrmPlantaChd::getState($oItem->state);?></td>
          </tr>
          <?php } ?>
        </table>
